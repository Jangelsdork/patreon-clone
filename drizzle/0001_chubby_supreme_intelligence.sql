...
/*
 ...
 Due to that we don't generate migration automatically and it has to be done manually
*/--> statement-breakpoint
ALTER TABLE organisation ADD `individuals` text NOT NULL REFERENCES individual(id);--> statement-breakpoint
/*
 ...
 Due to that we don't generate migration automatically and it has to be done manually
*/--> statement-breakpoint
ALTER TABLE `incidents` DROP COLUMN `userId`;--> statement-breakpoint
